...
class ModnetWebcamSession(CustomBaseSession):
    ...
    def download_models(cls, *args, **kwargs):
        ...
        if not os.path.exists(os.path.join(cls.u2net_home(), fname)):
            pooch.retrieve(
                ...
                path=os.path.join(cls.u2net_home(), "modnet-w/"),
                progressbar=True,
            )
            ...
            pooch.retrieve(
                ...
                known_hash=None,
                fname=f"__init__.py",
                path=os.path.join(cls.u2net_home(), "modnet-w/src/models/backbones"),
                progressbar=True,
            )
            ...
            pooch.retrieve(
                "https://storage.openvinotoolkit.org/repositories/open_model_zoo/public/2022.2/modnet-webcam-portrait-matting/modnet_webcam_portrait_matting.ckpt",
                known_hash=None,
                fname=f"modnet_webcam_portrait_matting.ckpt",
                path=os.path.join(cls.u2net_home(), "modnet-w/"),
                progressbar=True,
            )

            replace_line(
                os.path.join(cls.u2net_home(), "modnet-w/export_onnx.py"),
            ...
            subprocess.run([
                sys.executable,
                os.path.join(cls.u2net_home(), "modnet-w/export_onnx.py"),
                "--ckpt-path=" + os.path.join(cls.u2net_home(), "modnet-w/modnet_webcam_portrait_matting.ckpt"),
                "--output-path=" + os.path.join(cls.u2net_home(), "modnet-w/../modnet-w.onnx"),
            ])

            shutil.rmtree(os.path.join(cls.u2net_home(), "modnet-w/"))
